...
class StepResult:
    ...
    output: AgentOutput | None = None   # Agent output
    error: str | None = None            # Error message if failed
    requires_revision: bool = False        # If the next step should revise
    user_intervention: str | None = None # Possible user intervention
...
def load_agent_config(config_path: str | None = None) -> dict:
    """
