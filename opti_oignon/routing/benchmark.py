...
class BenchmarkResult:
    ...
    user_score: int | None = None  # 0-10 user score (optional)
    ...
    def run(
        ...
        if models:
            ...
            if not models_to_test:
                print("[ERR] None of the specified models are available")
                return []
        else:
