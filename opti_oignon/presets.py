...
from .config import DATA_DIR, config, load_yaml, save_yaml
...
TASK_KEYWORDS = {
    ...
    "simple_question": [
        "what is", "it is quoi", "explain", "explique", "how does", "comment",
...
class Preset:
    ...
    custom_prompt: str | None = None  # Custom prompt (override)
...
class PresetManager:
    ...
    def get_for_task(self, task: str) -> Preset | None:
        """
    ...
    def find_by_keywords(self, text: str, min_matches: int = 1) -> Preset | None:
        """
    ...
    def update(self, preset_id: str, **kwargs) -> Preset | None:
        """
    ...
    def duplicate(self, preset_id: str, new_id: str, new_name: str) -> Preset | None:
        """
...
def find_preset_by_keywords(text: str) -> Preset | None:
...
if __name__ == "__main__":
    ...
    print("  Task: code_r, Name: 'Ecology R Analysis'")
